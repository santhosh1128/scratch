...
const {url}=require('./ts');
// const modelJson = require('./model');
...
class Scratch3NewBlocks {
            ...
            "blocks": [
                        {
                            "opcode": "fetchURL",
                            "blockType": "command",
                            "text": "enter value1 [value1] ,enter value2 [value2] ,enter value3 [value3] ,enter value4 [value4]  ",
                            "arguments": {
                                "value1": {
                                    "type": "string",
                                    "defaultValue": "0",
    ...
    fetchURL({value1,value2,value3,value4},util) {
       debugger;
...
/* <script src="https://unpkg.com/regenerator-runtime@0.13.1/runtime.js"></script> */
       ...
       script1.src = 'https://unpkg.com/regenerator-runtime@0.13.1/runtime.js';  
    ...
    //   ).then((res) => {
    //       debugger;
    //       var model =  ts.loadLayersModel('model.json');
    //       model.predict(url.tensor2d([[value1, value2, value3, value4]])).print();
    //   })

    //    console.log("started");
            async function loadModel(){
                var ss=fetch('http://127.0.0.1:8080/model.json')
                    .then(response => response.json())
                const model = await tf.loadLayersModel(ss);
                model.predict(tf.tensor2d([[value1, value2, value3, value4]])).print();
            }
            loadModel();
